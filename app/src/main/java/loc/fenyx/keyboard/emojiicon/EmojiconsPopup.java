...
package loc.fenyx.keyboard.emojiicon;

import java.util.Arrays;
import java.util.List;

import loc.fenyx.keyboard.R;
import loc.fenyx.keyboard.emoji.Emojicon;
import loc.fenyx.keyboard.emoji.Nature;
import loc.fenyx.keyboard.emoji.Objects;
import loc.fenyx.keyboard.emoji.People;
import loc.fenyx.keyboard.emoji.Places;
import loc.fenyx.keyboard.emoji.Symbols;
